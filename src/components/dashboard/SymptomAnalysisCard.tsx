...
import { Search, Zap } from 'lucide-react'; // Zap for Analyze
    ...
    <Card className="glass-panel">
      ...
      <CardContent>
        <div className="space-y-4">
          ...
          />
          <Button onClick={onSubmit} disabled={isAnalyzing || !symptoms.trim()} className="w-full bg-medical-primary hover:bg-medical-primary/90">
            {isAnalyzing ? (
              <>
